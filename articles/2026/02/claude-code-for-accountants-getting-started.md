...
### 1. Model
Your AI engine. In Claude Code, I use Opus 4.5. ChatGPT users are probably on GPT 5.2, Gemini users on Gemini 3. Switching models is trivial in Claude Code. And there are other CLI tools too, including OpenCode and other multi-model agent options, but Claude Code is the flagship right now.
